            ...
            <div class="row">
                <div class="col-sm-4 offset-sm-4">
                    <div class="img-positive mt-5">
                        <img src="img/positive/hospital1.svg" alt="hospital1" />
                    </div>
                </div>
                <div class="col-sm-10 offset-sm-1">
                    <div class="positive-content text-center mt-5">
                        <div class="positive3 mb-5">
                            <h1>
                                COVID-19
                                <br>
                        ...
                        <h4 class="mb-3">
                            ...
                            <span class="font-weight-light text-danger">Positive
                                <span class="text-black-50">( Almost confirmed case of COVID-19 positive )</span></span>
                        </h4>
                        <h4 class="mb-5">
                            Advice:
                            <span class="font-weight-light text-black-50">Isolation and contact doctor immediately
                                and follow advice and hospitalized as soon as possible</span>
                        </h4>

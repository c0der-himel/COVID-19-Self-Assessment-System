                    ...
                    <div class="positive-content text-center mt-5">
                        ...
                        <h4 class="mb-3">
                            ...
                            <span class="font-weight-light text-danger">Positive
                                <span class="text-black-50">( Possible suspected case for COVID-19 affected
                                    )</span></span>
                        </h4>
                        <h4 class="mb-5">
                            Advice:
                            <span class="font-weight-light text-black-50">Isolation and contact doctor and follow advice.</span>
                        </h4>
                        <div class="again">
